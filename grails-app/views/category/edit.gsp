...
<content tag="breadcrumb">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-dark active" aria-current="page">${this.category.id}</li>
    </ol>
    ...
    <div class="col-12">
      <div class="card ">
        ...
        <div class="card-body pb-2">
          ...
          <g:form controller="category" action ="update" method="PUT" id="${this.category.id}" class="form">
            <div class="input-group input-group-outline mb-4">
              <label class="form-label">Name</label>
              <g:textField name="categoryName"  class="form-control" id="categoryName" value="${this.category.categoryName}" />
            </div>

            <g:submitButton name="update" class="btn bg-gradient-primary mb-4"
                            value="Save" />
          </g:form>
        </div>
      </div>
